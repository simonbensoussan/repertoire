...
public class Test extends JFrame {
	...
	public JComboBox <Society> comboSociety;
...
//======================================================================
	 ...
	 */
		...
		getContentPane().setBackground(new Color(245, 222, 179));
			...
			connect = SqliteSector.dbConnector();
			connect = SqliteSociety.dbConnector();
			FunctionDatabase.fillComboSociety(comboSociety);
			searchFillTable();
...
/*		public void showContact(){
	...
	private void searchByName() {
		String contact = tf_search.getText().toUpperCase();
		ArrayList<Contact>mesContacts = new ArrayList<>();
		mesContacts = SqliteContact.getContactList();
		ArrayList<Contact>mesContacts_2 = new ArrayList<>();
		
		for (Contact cont : mesContacts) { //variable upperCase
			if(cont.getName().toUpperCase().matches(contact + ".*"))
				mesContacts_2.add(cont);
			
		}
		FunctionDatabase.fillTableSearch(table, mesContacts_2);
	}
	...
	public  void openWebPage() throws IOException, URISyntaxException
	{
		...
		String site ="";
		ArrayList<Society>MesSocietes= new ArrayList<Society>();
		MesSocietes = SqliteSociety.getSocietyList();
		for (Society society : MesSocietes) {
			if(society.getName().equals(item_selected))
				site = society.getWeb_site();
		}
...
//==================================================================================================
	...
	public void init() {
		...
		//==================== PANEL CATEGORY =======================================================================================
				...
				panelCategory.setBackground(new Color(245, 222, 179));
...
//==================== PANEL SOCIETY =================================================================================	
		...
		panelSociety.setBackground(new Color(245, 222, 179));
		...
		comboSociety.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
			
            	String item = (String) comboSociety.getSelectedItem();
        		ArrayList<Society>MesSocietes= new ArrayList<Society>();
        		MesSocietes = SqliteSociety.getSocietyList();
        		...
        		int id = 0;
        		String nomCatg = "";
        		for (Society soc : MesSocietes) {
        			if(soc.getName().equals(item))
        				id = soc.getSector();
        		}
        		for (Sector  sec : MesSectors) {
        			if(sec.getId() ==id)
        				nomCatg = sec.getLibeller();
        		}
        		labelCategorie.setText(nomCatg.toUpperCase());
			}		
		...
		panelSociety.add(comboSociety);
			...
			panelForm.setBackground(new Color(245, 222, 179));
